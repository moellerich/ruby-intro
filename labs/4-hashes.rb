...
# dig through bitcoin_data to find the conversation rate (rate_float)
...
# write the value of the user's bitcoin on the screen
puts "You have BTC worth #{bitcoin_value} USD"